...
- **QLoRA.** Training on a 4-bit NF4 base cut peak training memory from 9.81 to 6.97 GiB. It was 27% slower in steady state (12.54 against 17.09 examples/s). Test accuracy dropped by 0.6 / 0.2 / 1.1 points. Only the product-type drop is significant (p = 0.027).
